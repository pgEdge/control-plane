...
type Orchestrator interface {
	...
	StopInstance(ctx context.Context, rc *resource.Context, instanceID string) error
	StartInstance(ctx context.Context, rc *resource.Context, instanceID string) error
}
