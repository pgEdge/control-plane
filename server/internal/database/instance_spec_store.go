...
func (s *InstanceSpecStore) GetByKeys(databaseID string, instanceIDs ...string) storage.GetMultipleOp[*StoredInstanceSpec] {
...
func (s *InstanceSpecStore) GetByDatabase(databaseID string) storage.GetMultipleOp[*StoredInstanceSpec] {
