...
var _ resource.StateMigration = (*Version_2_0_0)(nil)

// Version_2_0_0 removes swarm.service_user_role resources and scrubs
...
type Version_2_0_0 struct{}

func (v *Version_2_0_0) Version() *ds.Version {
	return resource.StateVersion_2_0_0
}

func (v *Version_2_0_0) Run(state *resource.State) error {
