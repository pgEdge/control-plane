...
func NewVersions(cfg config.Config) *Versions {
	...
	versions.addImage(ds.MustPgEdgeVersion("16.14", "5"), &Images{
		PgEdgeImage: imageTag(cfg, "16.14-spock5.0.8-standard-1"),
	})
	...
	versions.addImage(ds.MustPgEdgeVersion("17.10", "5"), &Images{
		PgEdgeImage: imageTag(cfg, "17.10-spock5.0.8-standard-1"),
	})
	...
	versions.addImage(ds.MustPgEdgeVersion("18.4", "5"), &Images{
		PgEdgeImage: imageTag(cfg, "18.4-spock5.0.8-standard-1"),
	})

	versions.defaultVersion = ds.MustPgEdgeVersion("18.4", "5")
