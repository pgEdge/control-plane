...
- in the autogenerated help text in `restish`: `restish control-plane-local-1 --help`
- in the Go source of the API specification in `api/apiv1/design`
- in the generated OpenAPI spec in `api/apiv1/gen/http/openapi.yaml`
