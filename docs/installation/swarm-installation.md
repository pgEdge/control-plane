...
services:
  host-1:
    image: ghcr.io/pgedge/control-plane:v0.10.1
    command: run
    environment:
...
<button id="generateBtn" data-input="nodes" data-output="global-output" data-version="v0.10.1" class="md-button yaml-generate">Generate Stack Definition</button>
