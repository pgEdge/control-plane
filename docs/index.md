...
- flexible orchestrator support: run Postgres as Docker containers via **Docker Swarm**, or as native Linux services via **systemd** on bare metal or VMs without containers (preview).
